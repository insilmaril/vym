...
To enter the URL of any document, press \key{U} or right-click  onto a
...
To link to to another map right click on a branch and choose "Edit \vym
link". A file dialog opens where you can choose the map. 
...
or clicking the 
    \begin{center}
	\includegraphics[width=0.5cm]{../icons/newmapcenter.png}
    \end{center}
...
%FIXME-3 Delete xLink in TreeEditor?
...
\section{Scripts} \label{scripts}   %FIXME-2
