...
\title{
    ...
    \\
VYM \\ -- \\View Your Mind\\ {\small Version 2.0.0}}
...
start
-t           testmode    Test mode, e.g. no autosave and changing of its
setting
...
\subsection{Macro to create a rounded rectangle frame}
\begin{code}
\# Macro F12
...
\subsection{Batch script to export all maps as images}
...
\subsection{Full scripting using ruby and DBUS}
